 ...
 * generated in the webservice_server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://webservice_server/", "getWeatherByCityResponse");
    private final static QName _GetWeatherByCity_QNAME = new QName("http://webservice_server/", "getWeatherByCity");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice_server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_server/", name = "getWeatherByCityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_server/", name = "getWeatherByCity")
